...
sudo ip6tables -t nat -A POSTROUTING -s fd80::/64 -j MASQUERADE
...
The host is assigned the hardware address `02-00-00-00-00-02`, IPv4 address `192.168.69.1`, and IPv6 address `fd80::1`.
